...
export const challenges: Challenge[] = [
  ...
  {
    id : 43,
    title : 'Challenge 43 : Print FizzBuzz',
    description : `Challenge : FizzBuzz Challenge
    ===========================================================
    ...
    placeholder : `function fizzBuzz(startNum, endNum){
      // Your code here
    }
    fizzBuzz(1,15);
    `,
  ...
  {
    id : 47,
    title : 'Day 47 : Extract Numbers from String',
    description: `Programming Challenge: Extract Numbers from a String
    ===========================================================
  ...
  {
    id : 49,
    title : 'Day 49 : Validate Date',
    description : `Programming Challenge: Date Validation
    ===========================================================
